...
{
  int dlina = 7;
  TBitField bf1(dlina), bf2(dlina);

  bf1.SetBit(1); bf1.SetBit(3);

  bf2.SetBit(1); bf2.SetBit(2);

  EXPECT_NE(bf1, bf2);
}
//---------------------------------------------------------------------------------
TEST(TBitField, eq_bitfields_true_check)
{
	int dlina = 7;
	TBitField bf1(dlina), bf2(dlina);
...
//---------------------------------------------------------------------------------
TEST(TBitField, nonequivalence_bitfields_false_check)
{
	int dlina = 7;
	TBitField bf1(dlina), bf2(dlina);
